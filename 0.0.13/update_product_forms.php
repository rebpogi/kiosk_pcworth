        ...
        <div class="form-wrapper">
          <form id="Update_product_form" method="POST" enctype="multipart/form-data">
            <input type="hidden" name="ID" value="<?= htmlspecialchars($product['ID']) ?>">
                ...
                <div class="input-group">
                    <div class="input-field">
                        ...
                        <select id="category" name="category" required>
                            ...
                            <?php
                            $categories = ["CPU", "GPU", "MOBO", "RAM", "SSD", "HDD", "PSU","Monitor","Mouse","Keyboard", "HEATSINK", "CASE", "CASE FANS", "accessories"];
                  ...
                  <div class="input-group">
                    <div class="input-field">
                      ...
                      <select id="Form_factor" name="Form_factor" required>
                        <option value="MINI-ITX" <?= ($form_factor == 'MINI-ITX') ? 'selected' : '' ?>>Mini-ITX</option>
                        <option value="MICRO-ITX" <?= ($form_factor == 'MICRO-ITX') ? 'selected' : '' ?>>Micro-ITX</option>
                        <option value="ATX" <?= ($form_factor == 'ATX') ? 'selected' : '' ?>>ATX</option>
                        <option value="Extended-ATX" <?= ($form_factor == 'Extended-ATX') ? 'selected' : '' ?>>Extended-ATX</option>
                      </select>
                    </div>
                    ...
                    <div class="input-field">
                      ...
                      <select id="Socket_type" name="Socket_type" required>
                        <option value="PGA" <?= ($socket_type == 'PGA') ? 'selected' : '' ?>>PGA (Pin Grid Array)</option>
                        <option value="LGA" <?= ($socket_type == 'LGA') ? 'selected' : '' ?>>LGA (Land Grid Array)</option>
                      </select>
                    </div>
                  </div>
                ...
                <p>
                     <br>
                    <input type="checkbox" id="status" name="status" <?= ($product['status'] === 'Hidden') ? 'checked' : '' ?>> Hide product on kiosk
                </p>
