          ...
          <div class="flex items-center gap-4">
            ...
            <div>
              ...
              <div class="flex items-center gap-2 mt-2">
                ...
                <button type="button" class="qty-btn-minus bg-blue-600 text-white px-3 py-1 rounded hover:bg-blue-700" 
                        data-product-id="<?= $id ?>">-</button>

                <input type="text" id="qty-<?= $id ?>" class="qty-input w-16 text-center border rounded px-2 py-1" 
                       data-product-id="<?= $id ?>" data-stock="<?= $stock ?>" 
                       value="<?= $item['quantity'] ?>" readonly />

                <button type="button" class="qty-btn-plus bg-red-600 text-white px-3 py-1 rounded hover:bg-red-700" 
                        data-product-id="<?= $id ?>">+</button>
              </div>
            </div>
          </div>
